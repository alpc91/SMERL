...
from brax.v1.experimental.composer.components import register_component
...
def match_group_name(name: str, group_name):
  """Check comp_name matches name, e.g. ('a1__a2___dist','a1','a2')-->True."""
  return name.startswith(f'{group_name}{GROUP_SPLITTER}')
