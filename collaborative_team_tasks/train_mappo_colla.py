...
from algo import mappo_colla as mappo_colla
...
flags.DEFINE_string('modelname', '', 'which model.')
...
#   from models.SHGN import ModelTest
...
# ################model test#####################
  ...
  inference_fn, params, _ = mappo_colla.train(
